#!/usr/bin/env python3
'''
Auto-generated training script for avatar.style.animal_traits
...
OUTPUT_DIR = Path("/Users/gareth/Code/garethapi/tools/talent-factory/talents/avatar/avatar.style.animal_traits")
TRAIN_DATA_DIR = Path("/data/avatar/style/animal_traits/images")
RESOLUTION = 640
LORA_RANK = 16
