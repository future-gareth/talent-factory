#!/usr/bin/env python3
'''
Auto-generated training script for avatar.identity.dot_kairo
...
OUTPUT_DIR = Path("/Users/gareth/Code/garethapi/tools/talent-factory/talents/avatar/avatar.identity.dot_kairo")
TRAIN_DATA_DIR = Path("/data/avatar/identity/dot_kairo/images")
RESOLUTION = 640
LORA_RANK = 16
